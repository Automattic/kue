...
exports.get = function(id, fn){
  ...
  client.hgetall('q:job:' + job.id, function(err, hash){
    ...
    job._delay_between_attempts = hash.delay_between_attempts;
...
/**
 * Set the delay between attempts in `ms`.
 *
 * @param {Number} ms
 * @return {Job|Number}
 * @api public
...
Job.prototype.attemptsDelay = function(ms){
  if (0 == arguments.length) return this._delay_between_attempts;
  this._delay_between_attempts = ms;
  this._state = 'delayed';
  return this;
};
...
Job.prototype.update = function(fn){
  ...
  if (this._delay_between_attempts) this.set("delay_between_attempts", this._delay_between_attempts);
