...
Job.prototype.state = function( state, fn ) {
  ...
  //record time of state change in time series collection - 1 hour granularity
  multi
    .zadd(client.getKey('jobs:' + state + ':' + (Math.floor(Date.now() / 3600000) * 3600000)), this._priority, this.zid);
