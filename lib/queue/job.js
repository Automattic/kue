...
exports.range = function (from, to, order, fn) {
    /*redis*/Job.client/*()*/.zrange('q:jobs', from, to, get(fn, order));
};
...
exports.rangeByState = function (state, from, to, order, fn) {
    /*redis*/Job.client/*()*/.zrange('q:jobs:' + state, from, to, get(fn, order));
};
...
exports.rangeByType = function (type, state, from, to, order, fn) {
    /*redis*/Job.client/*()*/.zrange('q:jobs:' + type + ':' + state, from, to, get(fn, order));
};
...
//    multi.zrem('q:jobs', this.id);
    ...
    multi.exec(function (err, replies) {}.bind(this));
    fn && fn(/*err*/);
    return this;
};
...
Job.prototype.save = function (fn) {
    ...
    client.incr('q:ids', function (err, id) {
        ...
        self.subscribe(function () {
            ...
            client.zadd('q:jobs', self._priority, self.id);
            self.update(fn);
        }.bind(this));
    }.bind(this));
    return this;
