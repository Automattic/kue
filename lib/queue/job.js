...
exports.range = function(from, to, fn){
  pool.alloc().zrange('q:jobs', from, to, get(fn));
};
...
exports.rangeByStatus = function(status, from, to, fn){
  pool.alloc().zrange('q:jobs:' + status, from, to, get(fn));
};
...
exports.rangeByType = function(type, status, from, to, fn){
  pool.alloc().zrange('q:jobs:' + type + ':' + status, from, to, get(fn));
};
