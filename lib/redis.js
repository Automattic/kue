...
module.exports = function redisInstance(){
  ...
  self.configureFactory = function( options, queue ) {
    ...
    self.createClient = function() {
      var clientFactoryMethod = options.redis.createClientFactory || self.createClientFactory;
  ...
  self.createClientFactory = function( options ) {
  ...
  self.client = function() {
    return self._client || (self._client = self.createClient());
  };
  ...
  self.pubsubClient = function() {
    return self._pubsub || (self._pubsub = self.createClient());
  };
   ...
   */
  self.reset = function() {
    self._client && self._client.quit();
    self._pubsub && self._pubsub.quit();
    self._client = null;
    self._pubsub = null;
  };
