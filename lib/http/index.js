...
app.post('/job', provides('json'), bodyParser.json(), bodyParser.urlencoded({ extended: false }), json.createJob);

// routes
app.get('/', function (req, res) {
    var context = app.mountpath || req.baseUrl || app.path();
    // remove additional slash from context
    // otherwise we can't mount same app on / and on /path
