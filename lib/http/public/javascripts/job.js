...
Job.prototype.render = function(){
  ...
  el.find('.created_at').text(relative(Date.now() - this.created_at));
  el.find('.updated_at').text(relative(Date.now() - this.updated_at));
  el.find('.failed_at').text(relative(Date.now() - this.failed_at));
