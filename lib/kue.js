...
/**
 * Expose the global prefix for Kue.
 */
...
Queue.prototype.setting = function(name, fn){
  this.client.hget(exports.prefix + ':settings', name, fn);
  return this;
};
  ...
  while (n--) {
    ...
    (function(worker){
      ...
      worker.on('job complete', function(job){
        self.client.incrby(exports.prefix + ':stats:work-time', job.duration);
      });
    })(worker);
    // save worker
...
Queue.prototype.types = function(fn){
  this.client.smembers(exports.prefix + ':job:types', fn);
  return this;
};
...
Queue.prototype.state = function(state, fn){
  this.client.zrange(exports.prefix + ':jobs:' + state, 0, -1, fn);
  return this;
};
...
Queue.prototype.workTime = function(fn){
  this.client.get(exports.prefix + ':stats:work-time', function(err, n){
    if (err) return fn(err);
...
Queue.prototype.card = function(state, fn){
  this.client.zcard(exports.prefix + ':jobs:' + state, fn);
  return this;
};
