...
function Queue( options ) {
    ...
    this._promote( options.promotion );
}
...
Queue.prototype._promote = function( promotionOptions ) {
    ...
    // Check for jobs to promote on start, and then every interval
    promoteJobs();
    this.promoter = setInterval(promoteJobs, timeout);
};
