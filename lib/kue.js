...
Queue.prototype.promote = function( ms, l ) {
  console.warn('promote method is deprecated, ' +
    'you don\'t need to call this anymore. ' +
    'You can safely remove it from your code now.');
};
...
Queue.prototype.checkActiveJobTtl = function( ttlOptions ) {
  ...
  var client              = this.client
    , self                = this
    , timeout             = ttlOptions.interval || 10000
    , lockTtl             = 2000
...
Queue.prototype.range = function( from, to, order, fn ) {
  this.client.zrange(this.client.getKey('jobs'), from, to, get(this.client, order, fn));
};
...
Queue.prototype.rangeByState = function( state, from, to, order, fn ) {
  this.client.zrange(this.client.getKey('jobs:' + state), from, to, get(this.client, order, fn));
};
...
Queue.prototype.rangeByType = function( type, state, from, to, order, fn ) {
  this.client.zrange(this.client.getKey('jobs:' + type + ':' + state), from, to, get(this.client, order, fn));
};
