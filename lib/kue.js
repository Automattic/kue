...
/**
 * Initialize a new job `Queue` and get all active jobs
 * to change their status to inactive, to be picked by Worker.
 *
 * @api public
 */
...
function Queue() {
  ...
  Job.rangeByState('active', 0, 0, 'asc', function (err, jobs) {
